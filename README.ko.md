...
현재는 Phase 3 스냅샷 비교까지 완료된 상태입니다.
...
- Restore, integrity verification, block garbage collection, compression, encryption, content-defined chunking은 이후 알고리즘 후보입니다. Compression은 `docs/specs/0005-block-compression.md`에 future raw-identity payload encoding으로 기록합니다.
