...
현재는 Phase 4 스냅샷 복원 core flow, Home/adaptive navigation MVP, Phase 5의 첫 무결성 검증 slice까지 완료된 상태입니다.
...
- healthy report는 현재 참조되는 raw block들이 snapshot metadata와 일치한다는 뜻입니다.
...
- Block garbage collection, 자동 복구, compression, encryption, content-defined chunking은 이후 알고리즘 후보입니다. Compression은 `docs/specs/0005-block-compression.md`에 future raw-identity payload encoding으로 기록합니다.
